/*
package com.hooptap.brandsampleaws.Custom;
...
public class MyEditText extends EditText {
    private Drawable imgCloseButton = getResources().getDrawable(R.drawable.email);
    HashMap<String,Object> configuracion;
    ...
    void setConfiguration(HashMap<String,Object>configuracion){
       this.configuracion=configuracion;
    }
    void init() {
        (configuracion.get("type")!=null)?setInputType(InputType.TYPE_CLASS_NUMBER ):setInputType(InputType.TYPE_TEXT_VARIATION_EMAIL_ADDRESS );
